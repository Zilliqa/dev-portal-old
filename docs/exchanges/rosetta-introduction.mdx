...
The current supported Rosetta version is `v1.4.9`.

## Running Zilliqa Rosetta in your own environment

To run Zilliqa Rosetta, please refer to [Zilliqa-rosetta readme](https://github.com/Zilliqa/zilliqa-rosetta) on instruction on how to set it up. You can choose to either run a seed node together Rosetta or connect Rosetta to our public endpoing, `api.zilliqa.com`. 
...
You can refer to the Zilliqa Rosetta APIs for the list of supported restful API. If need you need a SDK, the Rosetta project has provided a [Golang Rosetta SDK](https://github.com/coinbase/rosetta-sdk-go).