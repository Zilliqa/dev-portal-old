...
Create a new Transaction object and send it to the network to be process. <br/> See [Quick Start](https://github.com/Zilliqa/zilliqa-js#quick-start) in Javascript-SDK for an example of how to construct a Transaction object.
