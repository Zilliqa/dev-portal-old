...
This guide is meant for wallet developers looking to add support for [ZRC2 tokens](https://github.com/Zilliqa/ZRC/blob/master/zrcs/zrc-2.md) in their wallet.
