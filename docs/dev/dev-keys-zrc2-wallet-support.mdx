...
To check whether a contract to be compliant with ZRC-2 standard immutable variables requirement, you can check whether has the contract implements the [manadatory immutable variables](#immutable-variables).
