...
To add your token to the token list on Zilswap, please refer the README.md file on this [repository](https://github.com/Switcheo/zilswap-token-list).

### Listing on Viewblock

To add your token's logo on Viewblock, please refer the README.md file on this [repository](https://github.com/Ashlar/cryptometa.git). Viewblock will also automatically assign a score to your token based on their judging criteria.
