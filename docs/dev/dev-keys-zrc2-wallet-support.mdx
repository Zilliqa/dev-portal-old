...
ZRC-2 contract consists of the following components in smart contracts as per the [specification](https://github.com/Zilliqa/ZRC/blob/master/zrcs/zrc-2.md#iv-specification).

### Error codes
| Name                        | Type    | Code | manadatory?                           |
| --------------------------- | ------- | ---- | ------------------------------------- |
...
## Check if the contract is compliant to ZRC-2 fungible Tokens standard
...
## Integration with ZRC-2 Fungle Tokens contract
