...
You would need to specify your API Key for Magic, which you'll get by signing up on Magic's [dashboard](https://dashboard.magic.link/signup) - if you face any issues, refer magic's [documentation](https://dashboard.magic.link/signup).
