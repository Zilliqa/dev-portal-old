...
The `Delegator` is a new role introduced in phase 1 of the Zilliqa seed node staking program. With the `Delegator`, there is a better separation of roles and privileges.
