...
- upgrading node
- zilliqa	
description: Staking Smart Contract
---
---
...
Also, if you need a small amount of testnet $ZIL from time to time, you can go to our [Testnet Faucet](https://dev-wallet.zilliqa.com/faucet) to request for it.
